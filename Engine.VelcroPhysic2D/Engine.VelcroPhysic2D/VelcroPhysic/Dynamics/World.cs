...
namespace Genbox.VelcroPhysics.Dynamics
{
    ...
    public class World
    {
		...
		public World(System.Numerics.Vector2 gravity) : this(new Vector2(gravity.X, gravity.Y)) { }
		public World(float gravityX,float gravityY) : this(new Vector2(gravityX,gravityY)) { }
		...
		/// --------------------
		/// <br/>
		/// return -1: ignore this fixture and continue. <br/>
		/// return  0: terminate the ray cast. <br/>
		/// return fraction: clip the ray to this point.<br/>
		/// return  1: don't clip the ray and continue.
		/// </summary>
		/// <param name="callback">Fixture that ray hitted, contact point,contact normal, fraction, return value</param>
        ...
        /// <summary>
        /// Clear All <see cref="Body"/>, <see cref="Controller"/>,<see cref="BreakableBody"/>
        /// </summary>
        public void Clear()
        {
            ProcessChanges();
