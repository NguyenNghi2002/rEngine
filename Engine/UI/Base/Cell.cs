...
namespace Engine.UI
{
	public class Cell 
	{
		...
		{
			Insist.IsTrue(size != null, "size cannot be null.");
		...
		{
			Insist.IsTrue(width != null, "width cannot be null.");
			Insist.IsTrue(height != null, "height cannot be null.");
		...
		/// <summary>
		/// Sets the alignment of the element within the cell. Set to  <see cref="Align.Center"/>, <see cref="Align.Top"/>, <see cref="Align.Bottom"/>,
		...
		/// <summary>
		/// Sets the alignment of the element within the cell to <see cref="Align.Center"/>. This clears any other alignment.
		/// </summary>
		public Cell Center()
		{
			align = centeri;
