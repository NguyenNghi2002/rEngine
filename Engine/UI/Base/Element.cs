...
namespace Engine.UI
{
	...
	public class Element : ILayout
	{
		...
		public virtual void Draw( float parentAlpha) => Validate();
        ...
        public bool ClipBegin() => ClipBegin(x, y, width, height);
		...
		public Vector2 ParentToLocalCoordinates(Vector2 parentCoords)
		{
			...
			{
				var radian = rotation * MathF.PI / 180f;
		...
		public virtual void DebugRender()
		{
			if (_debug)
            {
				Raylib_cs.Raylib.DrawRectangleLinesEx (new(x, y, width, height),1, Color.GREEN);
				Raylib_cs.Raylib.DrawTextPro(Raylib.GetFontDefault(),GetType().Name,new Vector2(x,y),Vector2.Zero,rotation,15,1,Color.GREEN);
            }
		}
		...
		/// <summary>
		/// Return point hover on <see cref="Element"/> , ortherwise return <see langword="null"/>
		/// </summary>
