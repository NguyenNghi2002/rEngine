...
namespace Engine.UI
{
	...
	/// functionality and more. A button may only be in one group at a time.<br/>
	/// <br/>
	/// The <see cref="CanCheck(Button, bool)"/>  method can be overridden to control if a button check or uncheck is allowed.
	/// </summary>
