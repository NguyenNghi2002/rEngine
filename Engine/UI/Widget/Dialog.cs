namespace Engine.UI
{
	 ...
	 * @param object The object that will be passed to {@link #result(Object)} if this button is clicked. May be null. */
		public Button AddButton(string text, TextButtonStyle buttonStyle, out Cell cell)
		{
			return AddButton(new TextButton(text, buttonStyle),out cell);
		}
	 ...
	 * @param object The object that will be passed to {@link #result(Object)} if this button is clicked. May be null. */
		public Button AddButton(Button button,out Cell cell)
		{
			cell = buttonTable.Add(button);
			return button;
		}
