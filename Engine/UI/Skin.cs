...
namespace Engine.UI
{
    public class Skin 
    {
        ...
        public static Skin CreateDefaultSkin() 
        {
            ...
            var checkboxOn = new Color(168, 207, 115, 255);
            var checkboxOff = new Color(63, 63, 63, 255);
            var checkboxOver = new Color(130, 130, 130, 255);
            var checkboxOverFontColor = new Color(220, 220, 220, 255);

            var barBg = new Color(78, 91, 98, 255);
            var barKnob = new Color(25, 144, 188, 255);
            var barKnobOver = new Color(168, 207, 115, 255);
            var barKnobDown = new Color(244, 23, 135, 255);

            var windowColor = new Color(17, 17, 17, 255);

            var textFieldFontColor = new Color(220, 220, 220, 255);
            var textFieldCursorColor = new Color(83, 170, 116, 255);
            var textFieldSelectionColor = new Color(180, 52, 166, 255);
            var textFieldBackgroundColor = new Color(22, 22, 22, 255);

            var scrollPaneScrollBarColor = new Color(44, 44, 44, 255);
            var scrollPaneKnobColor = new Color(241, 156, 0, 255);

            var listBoxBackgroundColor = new Color(20, 20, 20, 255);
            var listBoxSelectionColor = new Color(241, 156, 0, 255);
            var listBoxHoverSelectionColor = new Color(120, 78, 0, 255);

            var selectBoxBackgroundColor = new Color(10, 10, 10, 255);
        ...
        //public readonly static Skin DefaultSkin = CreateDefaultSkin();
#endif
        ...
        public Font GetFont(string name) => Get<Font>(name);
#endif
