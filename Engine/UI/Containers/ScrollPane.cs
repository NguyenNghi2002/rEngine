...
namespace Engine.UI
{
    ...
    public class ScrollPane : Group, IInputListener
    {
        ...
        public override void Layout()
        {
            ...
            _widgetAreaBounds = new Rectangle(bgLeftWidth, bgBottomHeight, _areaWidth, _areaHeight);
            ...
            if (_scrollX)
            {
                if (hScrollKnob != null)
                {
                    ...
                    _hScrollBounds = new Rectangle(boundsX, boundsY, _areaWidth, hScrollHeight);
                    ...
                    _hKnobBounds.x = _hScrollBounds.y;
                }
                else
                {
                    _hScrollBounds = new Rectangle();
                    _hKnobBounds = new Rectangle();
                }
            }
            ...
            if (_scrollY)
            {
                ...
                {
                    _vScrollBounds = new Rectangle();
                    _vKnobBounds = new Rectangle();
                }
            }
        ...
        bool IInputListener.OnMouseScrolled(int mouseWheelDelta)
        {
            ...
            if (_scrollY)
                ...
                SetScrollX(_amountX + Input.MouseWheelDelta * _scrollSpeed * scrollDirectionMultiplier);
        ...
        public override void Draw( float parentAlpha)
        {
            ...
            var transformation = ComputeTransform().ToMatrix4x4();
            if (transform)
            ...
            if (_style.Background != null)
                _style.Background.Draw( 0, 0, GetWidth(), GetHeight(), color);

            // caculate the scissor bounds based on the batch transform, the available widget area and the camera transform. We need to
            // project those to screen coordinates for OpenGL to consume.
            var scissor = CalculateScissors(_stage?.CameraUI,transformation, _widgetAreaBounds);
            ...
            if (_scrollX && _scrollY)
            {
                if (_style.Corner != null)
                    _style.Corner.Draw( _hScrollBounds.x + _hScrollBounds.width, _hScrollBounds.y,
            ...
            {
                if (_style.HScroll != null)
                    _style.HScroll.Draw( _hScrollBounds.x, _hScrollBounds.y, _hScrollBounds.width,
                        _hScrollBounds.height, color);
                if (_style.HScrollKnob != null)
                    _style.HScrollKnob.Draw( _hKnobBounds.x, _hKnobBounds.y, _hKnobBounds.width,
            ...
            if (_scrollY)
            {
                if (_style.VScroll != null)
                    _style.VScroll.Draw( _vScrollBounds.x, _vScrollBounds.y, _vScrollBounds.width,
                        _vScrollBounds.height, color);
                if (_style.VScrollKnob != null)
                    _style.VScrollKnob.Draw( _vKnobBounds.x, _vKnobBounds.y, _vKnobBounds.width,
        ...
        public override void DebugRender()
        {
            ...
            var scissor = CalculateScissors(_stage?.CameraUI, Rlgl.rlGetMatrixTransform(), _widgetAreaBounds);
