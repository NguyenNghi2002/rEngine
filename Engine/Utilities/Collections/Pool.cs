...
namespace Engine
{
    ...
    public static class Pool<T> where T : new()
	{
		...
		/// <summary>
		/// Pushes an item back on the stack <br/>
		/// <br/>
		/// Extend with <see cref="IPoolable"/>
		/// </summary>
		/// <param name="obj">Object.</param>
		public static void Free(T obj)
		{
			if (_objectQueue.Contains(obj)) throw new("already have");
	...
	/// <summary>
	/// Objects implementing this interface will have <see cref="Reset"/> called when passed to <see cref="Pool{T}.Free(T)"/>.
	/// </summary>
