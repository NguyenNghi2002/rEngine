...
{
    /// <summary>
    /// A Layer that contain object shape: <br/>
    /// 
    /// </summary>
    public class TmxObjectGroup : ITmxLayer
    {
        ...
        public TmxObjectGroup(TmxMap map,XElement xObjectGroup)
        {
            ...
            var colorAttr = xObjectGroup.Attribute("color");
    ...
    /// <summary>
    /// Element <see cref="TmxObject"/> contain in <see cref="TmxObjectGroup"/>
    /// </summary>
    public class TmxObject : ITmxElement
    {
        ...
        public TmxObject(TmxMap map,XElement xObject)
        {
            ...
            if (xGid != null)
            {
                Tile = new TmxLayerTile(map,(uint)xGid,
    ...
    /// <summary>
    /// <see cref="Basic"/> = square/box <br/>
    /// <see cref="Tile"/> = dynamic tile image <br/>
    /// <see cref="Ellipse"/> = Ellipse <br/>
    /// <see cref="Polygon"/> = closed sequence points  <br/>
    /// <see cref="Polyline"/> = non-closed sequence points  <br/>
    /// </summary>
    public enum TmxObjectType
    {
        ...
        /// <summary>
        /// Close sequence points / polygon
        /// </summary>
        Polygon,

        /// <summary>
        /// non-closed sequence points / line chain
        /// </summary>
        Polyline
    }
