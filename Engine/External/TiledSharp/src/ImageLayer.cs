...
namespace Engine.TiledSharp
{
    public class TmxImageLayer : ITmxLayer
    {
        ...
        public TmxImageLayer(TmxMap map,XElement xImageLayer, string tmxDir = "")
        {
            ...
            ParallaxFactorX = (double?)xImageLayer.Attribute("parallaxx") ?? 1.0;
            ParallaxFactorY = (double?)xImageLayer.Attribute("parallaxy") ?? 1.0;


            var colorAttr = xImageLayer.Attribute("color");
