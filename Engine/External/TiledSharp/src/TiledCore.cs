...
namespace Engine.TiledSharp
{
    public abstract class TmxDocument
    {
        ...
        protected XDocument ReadXml(string filepath)
        {
            ...
            else
            {
                ...
                TmxDirectory = Path.GetDirectoryName(fullpath);
            }
    ...
    {
        public static readonly TmxColor Default = new TmxColor()
        {
            R = 255,
            G = 255,
            B = 255,
...
#if RAYLIB
        public Color RayColor => new Color((byte)R, (byte)G, (byte)B, (byte)255);

        public static implicit operator Color(TmxColor color) => color.RayColor;
#endif
        private TmxColor() { }
