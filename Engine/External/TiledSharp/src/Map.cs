...
namespace Engine.TiledSharp
{
    ...
    public class TmxMap : TmxDocument
    {
        ...
        /// Load tmx file
        /// </summary>
        /// <param name="filename">name of tmx file (include ".tmx")</param>
        /// <param name="customLoader">customize way to read tileData</param>
        ...
        private void Load(XDocument xDoc)
        {
            ...
            foreach (var e in xMap.Elements("tileset"))
                Tilesets.Add(new TmxTileset(this, e, TmxDirectory, CustomLoader));
