...
namespace Genbox.VelcroPhysics.Collision.Shapes
{
    ...
    {
        internal Vertices _normals = new Vertices(Settings.MaxPolygonVertices);
        internal Vertices _vertices = new Vertices(Settings.MaxPolygonVertices);
        ...
        public PolygonShape() : base(ShapeType.Polygon, Settings.PolygonRadius)
        {
        }

        private void SetVertices(Vertices value)
        {
            ...
            ComputeProperties();
#if false
            Debug.Assert(vertices.Count >= 3 && vertices.Count <= Settings.MaxPolygonVertices, "Invalid Vertices count");
